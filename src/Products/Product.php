...
use Cynojine\Mtnmomo\MoResponses\Balance;
use Cynojine\Mtnmomo\MoResponses\Token;
use Cynojine\Mtnmomo\MoResponses\TransactionStatus;
use Cynojine\Mtnmomo\Config\Config;
use Cynojine\Mtnmomo\Config\SandboxUser;
...
{
    use Config, SandboxUser;

    const BASE_URL = "https://cynojine.com";
     ...
     */
    protected $callbackHost = "http://127.0.0.1:8000";

    /**
     * @var string $callbackUrl
     */
    protected $callbackUrl = "http://127.0.0.1:8000/callback";
